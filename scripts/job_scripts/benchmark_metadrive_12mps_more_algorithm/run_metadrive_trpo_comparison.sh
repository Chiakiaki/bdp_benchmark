#!/usr/bin/env bash
# Sequentially train the five 12 m/s (43.2 km/h) TRPO/TRPOBDP comparisons.
# From this bundle directory:
#   ./run_metadrive_trpo_comparison.sh
# From the bdp_benchmark repository root:
#   ./scripts/job_scripts/benchmark_metadrive_12mps_more_algorithm/run_metadrive_trpo_comparison.sh
